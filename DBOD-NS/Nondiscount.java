...
public class Nondiscount {
    ...
    public static void main(String[] args) {
        ...
        omaxprofit[0]=getProfit(matrix_distance, map_orders, map_vehicles, new_list, new_list1,1, given_dis);
        o_maxprofit+=omaxprofit[0];
        ...
        try {
            ...
            writer_profit.write("Nondiscount " +",");
            writer_profit.write(omaxprofit[0] + ","  );
            writer_profit.write("\n");
            writer_profit.write("\n"+"Nondiscountal total profit" +","+ o_maxprofit);
    ...
    public static double getProfit(double matrix_distance[][], HashMap<Integer, Integer> map_orders,
                                   HashMap<Integer, Integer> map_vehicles,
                                   ArrayList<Object[]> orders, ArrayList<Object[]> vehicles, int last, double given_dis) {
