...
public class Odiscount {
    ...
    public static void main(String[] args) {
        ...
        ebmaxprofit[0]=getMaxprofit(matrix_distance, map_orders, map_vehicles, new_list, new_list1, discount_arr0, 0, discount_arr0.length, n_divides, given_dis);
    ...
    public static double getMaxprofit(double[][] matrix_distance, HashMap<Integer, Integer> map_orders,
        ...
        int mod = ((right - left) % (n_divides+1) != 0) ? 1 : 0;
        int size = (right - left) / (n_divides+1) + mod;
        ...
        if(n_divides <=3){
            ...
            for(int i=left+size;i<=left+n_divides*size;i=i+size){
