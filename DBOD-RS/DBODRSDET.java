...
public class DBODRSDET {
    ...
    public DBODRSDET(Config config) {
        // Setup logger
    ...
    private Result simulate(ArrayList<Order> orders, ArrayList<Vehicle> vehicles, boolean baseline, boolean determined) {
        ...
        // System.out.println("Stage 1: " + orders.size() + " * " + vehicles.size());
        // s = System.currentTimeMillis();
        double origProfit = this.greedyDispatch(orders, vehicles, STAGE_WITHIN, 0, baseline);
        // e = System.currentTimeMillis();
        // System.out.println("Stage 1: " + orders.size() + " * " + vehicles.size() + ", " + (e-s));

        // 第二步：再派接驾距离大于全局最大距离
        // this.logger.info("------------------------------------------------------------");
        // this.logger.info("Stage 2");
        // System.out.println("Stage 2: " + orders.size() + " * " + vehicles.size());
        // s = System.currentTimeMillis();
        double addProfit = this.greedyDispatch(orders, vehicles, STAGE_BEYOND, 0, baseline);
        // e = System.currentTimeMillis();
        // System.out.println("Stage 2: " + orders.size() + " * " + vehicles.size() + ", " + (e-s));

        // 第三步：确定折扣因子
        // this.logger.info("------------------------------------------------------------");
        // this.logger.info("Stage 3");
        // System.out.println("Stage 3: " + orders.size() + " * " + vehicles.size());
        // s = System.currentTimeMillis();
        double gamma =  this.determineDiscount(orders, vehicles);
        // e = System.currentTimeMillis();
        // System.out.println("Stage 3: " + (e-s));

        // 第四步：最终派单
        // this.logger.info("------------------------------------------------------------");
        // this.logger.info("Stage 4");
        // System.out.println("Stage 4: " + origOrders.size() + " * " + origOrders.size());
        // s = System.currentTimeMillis();
        for (Vehicle v : origVehicles) { v.clear(); } // 清除由于上面过程分配给汽车的订单
        double discountProfit = this.greedyDispatch(origOrders, origVehicles, STAGE_FINAL, gamma, baseline);
        // e = System.currentTimeMillis();
        // System.out.println("Stage 4: " + origOrders.size() + " * " + origVehicles.size() + ", " + (e-s));
    ...
    public static void main(String[] args) {
        ...
        DBODRSDET algo = new DBODRSDET(config);
        algo.read();
